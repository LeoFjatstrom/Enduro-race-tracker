...
ActiveRecord::Schema[7.0].define(version: 2024_02_27_212045) do
  ...
  create_table "competition_entries", force: :cascade do |t|
    ...
    t.index ["competition_id", "start_number"], name: "index_competition_entries_on_competition_id_and_start_number", unique: true
